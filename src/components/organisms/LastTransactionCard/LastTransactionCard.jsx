      ...
      <div className="latest-transaction-card-container">
        <div className="last-transaction-card-header">
          ...
          <div className="last-transaction-card-chooser">
            <div
              className={
                selected === "new" ? " selected-transaction chooser" : "chooser"
              }
              onClick={() => {
                onChooserClicked("new");
              }}
            >
              <Label>Newest</Label>
            </div>
            <div
              className={
                selected === "old" ? " selected-transaction chooser" : "chooser"
              }
              onClick={() => {
                onChooserClicked("old");
              }}
            >
              <Label>Oldest</Label>
            </div>
